...
private[riak] final class RiakHttpBucket(helper: RiakHttpClientHelper, server: RiakServerInfo, name: String, val resolver: RiakConflictsResolver) extends RiakBucket {
